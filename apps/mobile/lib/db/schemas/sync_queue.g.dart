...
const SyncQueueSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'entityType': PropertySchema(
      ...
      name: r'entityType',
      type: IsarType.byte,
      enumMap: _SyncQueueentityTypeEnumValueMap,
    ),
...
SyncQueue _syncQueueDeserialize(
  ...
  object.entityType =
      _SyncQueueentityTypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          EntityType.order;
  object.id = id;
...
P _syncQueueDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_SyncQueueentityTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          EntityType.order) as P;
    case 3:
...
const _SyncQueueentityTypeEnumValueMap = {
  'order': 0,
  'customer': 1,
  'product': 2,
};
const _SyncQueueentityTypeValueEnumMap = {
  0: EntityType.order,
  1: EntityType.customer,
  2: EntityType.product,
};
...
extension SyncQueueQueryProperty
  ...
  QueryBuilder<SyncQueue, EntityType, QQueryOperations> entityTypeProperty() {
    return QueryBuilder.apply(this, (query) {
