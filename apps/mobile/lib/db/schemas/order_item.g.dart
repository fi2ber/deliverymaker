...
const OrderItemSchema = Schema(
  ...
  properties: {
    ...
    r'rejectedQuantity': PropertySchema(
      id: 5,
...
void _orderItemSerialize(
  ...
  writer.writeDouble(offsets[5], object.rejectedQuantity);
}
...
OrderItem _orderItemDeserialize(
  ...
  object.deliveredQuantity = reader.readDoubleOrNull(offsets[0]);
  ...
  object.rejectedQuantity = reader.readDoubleOrNull(offsets[5]);
  return object;
}
...
extension OrderItemQueryFilter
  ...
  QueryBuilder<OrderItem, OrderItem, QAfterFilterCondition>
      rejectedQuantityIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'rejectedQuantity',
      ));
    });
  }

  QueryBuilder<OrderItem, OrderItem, QAfterFilterCondition>
      rejectedQuantityIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'rejectedQuantity',
      ));
